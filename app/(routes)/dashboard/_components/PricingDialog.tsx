...
function PricingDialog() {
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    ...
    >
      ...
      <a
        href="#"
        className="mt-8 block rounded-full border border-indigo-600 bg-indigo-600 px-1 py-3 text-center text-sm font-medium text-white hover:bg-indigo-700 hover:ring-1 hover:ring-indigo-700 focus:ring-3 focus:outline-hidden"
      >
        Get Started
      </a>
    </div>
    ...
    <div className="rounded-2xl border border-gray-200 p-6 shadow-xs sm:px-8 lg:p-12">
      ...
      <a
        href="#"
        className="mt-8 block rounded-full border border-indigo-600 bg-white px-1 py-3 text-center text-sm font-medium text-indigo-600 hover:ring-1 hover:ring-indigo-600 focus:ring-3 focus:outline-hidden"
      >
        Get Started
      </a>
    </div>
