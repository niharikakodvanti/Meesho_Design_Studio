import { ChevronDown, Icon, LayoutGrid, LogOut, Settings, Users } from "lucide-react";
...
function SideNavTopSection({user,setActiveTeamInfo}:any) {
  ...
  return (
    ...
    <Popover>
      <PopoverTrigger>
        <div
          className="flex items-center gap-3 hover:bg-slate-200 p-3 rounded-lg cursor-pointer"
        >
      ...
      <PopoverContent className="ml-7 p-4">
        ...
        <div>
          {menu.map((item,index) => (
              ...
              <h2 key={item.id}className="flex gap-2 items-center p-2 hover:bg-gray-100 rounded-lg cursor-pointer text-sm"
